...
lilv_array[71][1][1]=0.0435;//商贷 1年
lilv_array[71][1][3]=0.0475;//商贷 1～3年
lilv_array[71][1][5]=0.0475;//商贷 3～5年
lilv_array[71][1][10]=0.0490;//商贷 5-30年
lilv_array[71][2][1]=0.0275;//公积金 1年
lilv_array[71][2][3]=0.0275;//公积金 1～3年
lilv_array[71][2][5]=0.0275;//公积金 3～5年
lilv_array[71][2][10]=0.0325;//公积金 5-30年
...
/*	//先清空月还款数下拉框
	...
	if (fmobj.type.value == 3 ){
		...
		if (fmobj.jisuan_radio[0].checked == true){
			//------------ 根据单价面积计算
			if (!reg_Num(fmobj.price.value)){alert("གོང་ཚད་བྲིས་གནང་རོགས་");fmobj.price.focus();return false;}
